...
if __name__ == "__main__":
    ...
    os.system('CGO_ENABLED=1 GOOS=windows GOARCH=amd64 go build -ldflags="-s -w" -buildmode=pie -trimpath -o xc.exe xc.go')
    os.system('CGO_ENABLED=1 GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -buildmode=pie -trimpath -o xc xc.go')
